...
This project is a simple web page presenting a recipe for a classic dish.

## Technologies Used 🛠️

- **HTML5**: The structure and content of the webpage are built using HTML5, ensuring semantic markup for better accessibility and search engine optimization.
